...
Each icon is a 160×160 headshot crop of a freely licensed photograph from
Wikimedia Commons. The crop is the only change made. The email footer prints
the credit line for whichever theme was used.

| File | Subject | Source | Author | License |
|---|---|---|---|---|
| macho_man.jpg | "Macho Man" Randy Savage, 1986 | https://commons.wikimedia.org/wiki/File:Randy_Savage_1986.jpg | Rob DiCaterino | [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/) |
